...
# ---------- Response Action (new — needed for /actions endpoints) ----------

class HostActionRequest(BaseModel):
    container_name: str            # Docker container name/hostname to act on
    network_name: Optional[str] = None   # required only for restore
