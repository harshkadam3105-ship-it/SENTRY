  ...
  return (
    <div className="glass-card p-5 space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-white/5 pb-4">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-semibold text-white tracking-wide uppercase">SOAR Remediation Console</h3>
          </div>
          <p className="text-xs text-slate-400 mt-0.5">Automated response playbooks & containment workflows</p>
        </div>
      ...
      <div className="flex items-center gap-2 border-b border-white/5 pb-2 text-xs">
        ...
        >
          <span>📋</span> Remediation Log ({auditLog.length})
        </button>
      </div>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  `}
                >
                  {isDone ? '✓ Playbook Finished' : isRunning ? 'Orchestrating…' : '▶ Run Full Playbook'}
                </button>
              </div>
            )
          })}
